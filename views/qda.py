...
def controls(feature_names):
    ...
    return feature_x, feature_y, test_size, reg_param
...
def train(df, y, feature_x, feature_y, test_size, reg_param):
...
def render():
    ...
    st.title("📈 Quadratic Discriminant Analysis")

    st.caption(
    "Interactive implementation using the Iris dataset."
    )
    ...
    with left:
            ...
            feature_x, feature_y, test_size, reg_param = controls(feature_names)
